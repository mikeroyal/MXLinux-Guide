...
1. [Getting Started](https://github.com/mikeroyal/MXLinux-Guide#getting-started)

2. [Getting Software](https://github.com/mikeroyal/MXLinux-Guide#getting-software)

3. [Gaming](https://github.com/mikeroyal/MXLinux-Guide#gaming)

4. [Game Development](https://github.com/mikeroyal/MXLinux-Guide#game-development)

5. [Setting up a macOS Workspace](https://github.com/mikeroyal/MXLinux-Guide#setting-up-a-macos-workspace)

6. [Setting up a Windows 10 Workspace](https://github.com/mikeroyal/MXLinux-Guide#setting-up-a-windows-10-workspace)

7. [Using Android and Android Apps on Linux](https://github.com/mikeroyal/MXLinux-Guide#using-android-and-android-apps-on-linux)

8. [Professional Audio/Video Editing](https://github.com/mikeroyal/MXLinux-Guide#professional-audio--video-editing)

9. [Kubernetes](https://github.com/mikeroyal/MXLinux-Guide#kubernetes)

10. [Machine Learning](https://github.com/mikeroyal/MXLinux-Guide#machine-learning)

11. [Robotics](https://github.com/mikeroyal/MXLinux-Guide#robotics)

12. [Open Source Security](https://github.com/mikeroyal/MXLinux-Guide#open-source-security)

13. [Differential Privacy](https://github.com/mikeroyal/MXLinux-Guide#differential-privacy)

14. [Cloud Native Development](https://github.com/mikeroyal/MXLinux-Guide#cloud-native-development)

15. [DevOps Development](https://github.com/mikeroyal/MXLinux-Guide#devops-development)

16. [Flutter Development](https://github.com/mikeroyal/MXLinux-Guide#flutter-development)

17. [Networking](https://github.com/mikeroyal/MXLinux-Guide#networking)

18. [Databases](https://github.com/mikeroyal/MXLinux-Guide#databases)


# Getting Started

[MX Linux](https://mxlinux.org/) is a cooperative venture between the [antiX](https://antixlinux.com/) and MX Linux communities. It is a family of operating systems that are designed to combine elegant and efficient desktops with high stability and solid performance.

[MX Linux – Xfce](https://mxlinux.org/download-links/) is the flagship version of MXLinux. It is a midweight desktop environment that aims to be fast and low-resource, while still being attractive and user-friendly. It supports a large range of hardware from older laptops to modern desktops. Available in Standard Debian Stable and [“Advanced Hardware Support”](https://mxlinux.org/blog/new-advanced-hardware-support-repo-ahs-for-short/) enabled versions.

[MXLinux - KDE](https://mxlinux.org/download-links/) is an advanced desktop “Plasma” and has a wide variety of powerful applications. It also includes an [“Advanced Hardware Support”](https://mxlinux.org/blog/new-advanced-hardware-support-repo-ahs-for-short/) enabled release that runs well on a wide variety of 64-bit machines.

[MX Linux – Fluxbox](https://mxlinux.org/download-links/) is a stacking window manager that unites the speed, low resource use and elegance of Fluxbox with the toolset from MX Linux – Xfce.

[MX-Fluxbox Raspberry Pi](https://mxlinux.org/blog/mx-fluxbox-raspberry-pi-ragout-now-final/) is an OS Image that provides a stable, fast and fun OS for use with [Raspberry Pi® 3](https://raspberrypi.org/) and later devices. It provides the user-centered goodness of MX Linux with the educational flexibility of [Raspberry Pi OS](https://www.raspberrypi.org/software/), implementing the light-weight and elegant desktop environment of MX’s unique implementation of Fluxbox and including elements from GNOME, Xfce and LXDE.
...
[MXLinux Community Repos](https://mxlinux.org/community-repos/)

[MXLinux Users Manual](https://mxlinux.org/manuals/)

[MXLinux Forum](https://forum.mxlinux.org)
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/MXLinux-Guide/pulls).


## License
[Back to the Top](https://github.com/mikeroyal/MXLinux-Guide/blob/main/README.md#table-of-contents)
